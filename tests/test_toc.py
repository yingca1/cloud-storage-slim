...
class TestCloudStorageSlim(unittest.TestCase):
    ...
    def test_upload_file(self):
        ...
        bucket_name = os.environ.get("TEST_BUCKET_TOC")
        ...
        remote_file_path = f"toc://{bucket_name}/{object_key}"
        cloud_storage_slim.copyto(local_file_path, remote_file_path)
        storage_client = cloud_storage_slim.get_client("toc")
    ...
    def test_list_objects(self):
        ...
        bucket_name = os.environ.get("TEST_BUCKET_TOC")
        object_key = "test_file_public_read.txt"
        remote_file_pattern = f"toc://{bucket_name}/{object_key}"
